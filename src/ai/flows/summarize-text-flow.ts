...
const SummarizeTextOutputSchema = z.object({
  ...
  productDescription: z.string().optional().describe('A brief description of the product or service from the text.'),
...
const prompt = ai.definePrompt({
  ...
  1. The company name.
  2. A concise description of the product or service being marketed.
