# 🤖 Copilot Workflow: Darrell Support Guardrails
...
Result: BREAKS WORKING CONFIG ❌
```

### ✅ CORRECT:
```
Darrell: "Can I test locally with npm run dev?"
Copilot: *checks .copilot-secrets-tracker.md - sees ✅ configured*
...
2. If status shows ✅ CONFIGURED, assume it exists and works
...
**DON'T intervene for:**
- "How do I run this locally?" → Just run it
- "Can I test without deploying?" → Yes, npm run dev
- "Set up dev environment" → It's already set up
